...
- **Session 2**: RAG for searching product documentation using Google Embeddings.
...
- Use Pinecone for storage and `@google/genai` for embeddings.

### 2. The Agentic Core
- Implement a support agent using `gemini-3-flash-preview` that can:
...
- **GET /usage**: Returns total tokens consumed.
